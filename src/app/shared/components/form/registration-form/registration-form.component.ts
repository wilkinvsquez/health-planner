...
export class RegistrationFormComponent {
  ...
  onSubmit() {
    ...
    this.registrationData.emit({
      ...
      password,
      userRelations: [
        //{ uid: 'wHZxojetK0QpaANJkWvXY0xPGHH2' },
        //{ uid: 'gmPnyRDY3IUZETgahIf0tubvE9k1' },
        //{ uid: 'Z6S1SyTztTZgBsb9eGppIA49eHn1' },
        //{ uid: 'igjqGhJz99VAsrQdw2k4qRgOKMQ2' },
        //{ uid: '8CPqU9v2WzOL6uoF0aZO1xBkbED3' },
      ],
      appointments: [],
      role: 'admin',
      active: true,
